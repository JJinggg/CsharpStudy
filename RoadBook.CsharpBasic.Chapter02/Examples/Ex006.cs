...
namespace RoadBook.CsharpBasic.Chapter02.Examples
{
    public class Ex006
    {
        public void Run()
        {
            ...
            Console.WriteLine("{0}{1}{2}{3}{4}{5}", strMessage[6], strMessage[7], strMessage[8], strMessage[9], strMessage[10], strMessage[11]);
            Console.WriteLine(strMessage);

            #region >> 참/거짓 변수
            bool bCalculate = (1 + 2 == 3);
            bool bCalculate2 = ((12 > 8) && (8 < 20));
            bool isContainsWorld = "Hello Csharp".Contains("Hello");
            #endregion

            Console.WriteLine("1+2 = 3 ? ({0})", bCalculate);
            Console.WriteLine("(12는 8보다 크고 8은 20보다 작다 ? ({0})", bCalculate2);
            Console.WriteLine("Hello Csharp 문장에 Hello가 포함되어 있다 ? ({0})", isContainsWorld);
            ...
            Console.WriteLine("dynamic 변수값은 {0}", dValue);
        }
    }
}
